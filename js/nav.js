...
const SERVICES_GROUPS = [
  ...
  },
  {
    ...
    icon: '💬',
    items: [
      { label: 'WhatsApp-Gateway', href: 'https://whatsapp.rosenweg4303.ch/', activeKey: 'whatsapp-bot', permAny: 'technik,praesident' },
      ...
      { label: 'Melde-Orte (QR-Codes)', href: 'melde-orte.html', activeKey: 'melde-orte', perm: 'reklamationen' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'SSH-Zugang', href: 'ssh-zugriffsmatrix.html', activeKey: 'ssh-zugang', permAny: 'technik,praesident' },
      { label: 'NOC', href: 'noc-fullscreen.html', activeKey: 'noc', permAny: 'technik,praesident' },
...
const RosenwegNav = {
  ...
  _pages() {
    return [
      ...
      { href: 'ssh-zugriffsmatrix.html', label: 'SSH-Zugang & Zugriffsmatrix', group: 'Infrastruktur', permAny: 'technik,praesident', aud: ['admin'] },
      { href: 'noc-fullscreen.html', label: 'NOC — Wandbildschirm', group: 'Infrastruktur', permAny: 'technik,praesident', aud: ['admin'] },
      ...
      { href: 'melde-orte.html', label: 'Melde-Orte (QR)', group: 'Vorgänge', perm: 'reklamationen' },
