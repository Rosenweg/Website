  ...
  _render(active, base) {
        ...
        <div class="hidden lg:flex items-center space-x-1">
          ...
          <div class="relative nav-dropdown nav-perm-group" data-perm-group="services">
            ...
            <div class="nav-dropdown-menu hidden absolute left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border py-1 z-50">
              ...
              <a href="${base}wohnungsverwaltung.html" data-perm-any="wohnungsverwaltung,bewohner-verwaltung,verwaltung" class="${dropA('verwaltung')} block px-4 py-2 text-sm">Objektverwaltung</a>
    ...
    <div id="nav-mobile-menu" class="hidden lg:hidden bg-white border-t">
      <div class="px-4 py-3 space-y-1">
        ...
        <a href="${base}wohnungsverwaltung.html" data-perm-any="wohnungsverwaltung,bewohner-verwaltung,verwaltung" class="block px-3 py-2 text-gray-700 hover:bg-gray-100 rounded text-sm">Objektverwaltung</a>
